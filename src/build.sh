...
# NNUE Builds
#ARCH="ARCH=x86-64-sse3"
#ARCH="ARCH=x86-64-sse3-popcnt"
#ARCH=ARCH=x86-64-ssse3"
#ARCH="ARCH=x86-64-sse41"
#ARCH="ARCH=x86-64-sse42"
ARCH="ARCH=x86-64-avx2"
#ARCH="ARCH=x86-64-avx512"
...
#make function
function mke() {
CXXFLAGS='-march=native -flto -mbmi' make -j30 $BUILD $ARCH $COMP "$@"
}
...
echo "$(<benchnodes.txt)"
sed -i.bak -e '1055,1172d' ../src/Makefile
sed '1054r benchnodes.txt' <../src/Makefile >../src/Makefile.tmp
